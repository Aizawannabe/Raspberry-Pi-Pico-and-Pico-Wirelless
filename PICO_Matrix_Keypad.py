...
R1 = machine.Pin(7,machine.Pin.OUT)
R2 = machine.Pin(6,machine.Pin.OUT)
R3 = machine.Pin(5,machine.Pin.OUT)
R4 = machine.Pin(4,machine.Pin.OUT)
C1 = machine.Pin(3,machine.Pin.IN,machine.Pin.PULL_DOWN)
C2 = machine.Pin(2,machine.Pin.IN,machine.Pin.PULL_DOWN)
C3 = machine.Pin(1,machine.Pin.IN,machine.Pin.PULL_DOWN)
